...
{
    /*ViewModel*/
    public abstract partial class VideoService<TViewModel, TModel> : IVideoService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
    ...
    /*Model*/
    public abstract partial class VideoService<TViewModel, TModel>
    {
