...
{
    /*ViewModel*/
    public abstract partial class RoleService<TViewModel, TModel> : IRoleService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
    ...
    /*Model*/
    public abstract partial class RoleService<TViewModel, TModel>
    {
