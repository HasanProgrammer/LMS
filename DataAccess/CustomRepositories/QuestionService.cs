...
{
    /*ViewModel*/
    public abstract partial class QuestionService<TViewModel, TModel> : IQuestionService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
    ...
    /*Model*/
    public abstract partial class QuestionService<TViewModel, TModel>
    {
