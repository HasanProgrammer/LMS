...
{
    /*ViewModel*/
    public abstract partial class CategoryService<TViewModel, TModel> : ICategoryService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
    ...
    /*Model*/
    public abstract partial class CategoryService<TViewModel, TModel>
    {
