...
{
    /*ViewModel*/
    public abstract partial class TermService<TViewModel, TModel> : ITermService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
        ...
        public virtual Task<TViewModel> FindWithIdAsNoTrackingAsync(int id, User user)
        {
            throw new System.NotImplementedException();
        }

        public virtual Task<TViewModel> FindWithIdAsNoTrackingAndActiveAsync(int id, User user)
        {
            throw new System.NotImplementedException();
        }
        ...
        public virtual Task<PaginatedList<TViewModel>> FindAllWithNoTrackingAndActiveForCategoryAndPaginateAsync(string category, int page, int count)
        {
            throw new System.NotImplementedException();
        }
    ...
    /*Model*/
    public abstract partial class TermService<TViewModel, TModel>
    {
        ...
        public virtual Task<TModel> FindWithNameEntityWithNoTrackingAsync(string name)
        {
            throw new System.NotImplementedException();
        }

        public virtual Task<(int, int, int, int, int, int, int, int, int, int)> FindCountEntityForCategoryWithNoTrackingAsync(string csh, string php, string python, string js, string asp, string laravel, string django, string reactjs, string sql, string mysql)
        {
            throw new System.NotImplementedException();
        }
    }
