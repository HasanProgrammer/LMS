...
{
    /*ViewModel*/
    public abstract partial class UserService<TViewModel, TModel> : IUserService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
        ...
        public virtual TModel FindWithIdEntityWithEagerLoading(string id)
        {
            throw new System.NotImplementedException();
        }
    }
    ...
    /*Model*/
    public abstract partial class UserService<TViewModel, TModel>
    {
