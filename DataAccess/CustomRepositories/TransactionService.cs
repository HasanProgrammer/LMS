...
{
    /*ViewModel*/
    public abstract partial class TransactionService<TViewModel, TModel> : ITransactionService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
    ...
    /*Model*/
    public abstract partial class TransactionService<TViewModel, TModel>
    {
