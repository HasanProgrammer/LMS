...
{
    /*ViewModel*/
    public abstract partial class AnswerService<TViewModel, TModel> : IAnswerService<TViewModel, TModel> where TViewModel : IViewEntity where TModel : IEntity
    {
        ...
        public virtual Task<PaginatedList<TViewModel>> FindAllForQuestionWithNoTrackingAndPaginateAsync(int id, int page, int count)
        {
            throw new System.NotImplementedException();
        }

        public virtual Task<PaginatedList<TViewModel>> FindAllForUserAndQuestionWithNoTrackingAndPaginateAsync(User user, int id, int page, int count)
        {
            throw new System.NotImplementedException();
        }
    }
    ...
    /*Model*/
    public abstract partial class AnswerService<TViewModel, TModel>
    {
