...
namespace DataService.Entity.ChapterServices.V1
{
    ...
    public partial class ChapterService
    {
        ...
        {
            return await _Context.Chapters.AsNoTracking().Select(Chapter => new ChaptersViewModel
            {
                Id         = Chapter.Id,
        ...
        {
            return await _Context.Chapters.AsNoTracking().Where(Chapter => Chapter.UserId.Equals(user.Id)).Select(Chapter => new ChaptersViewModel
            {
                Id         = Chapter.Id,
                UserId     = Chapter.UserId,
                UserName   = Chapter.User.UserName,
